...
const RidesPage = () => {
    ...
    const fetchRides = async () => {
        setLoading(true);
        try {
            const endpoint = activeTab === 'active' ? '/v1/admin/rides/active' : '/v1/admin/rides';
            const response = await api.get(endpoint);
            const data = activeTab === 'all' ? response.data.rides : response.data;
            setRides(data || []);
        } catch (error) {
    ...
    const cancelRide = async (rideId: string) => {
        ...
        try {
            await api.post(`/v1/admin/rides/${rideId}/cancel`, { reason: 'Admin cancelled' });
                            ...
                            <TableBody>
                                {rides.length === 0 ? (
                                    ...
                                    rides.map((ride) => {
                                        ...
                                        return (
                                            <>
                                                <TableRow key={ride.id} className="cursor-pointer hover:bg-gray-50">
                                                    <TableCell>
                                                        <button
                                                    ...
                                                    <TableCell>
                                                        <div>
                                                            ...
                                                            <p className="text-xs text-gray-500">{ride.riderId.substring(0, 8)}...</p>
                                                        </div>
                                                    </TableCell>
                                                    <TableCell>
                                                        {ride.driverInfo ? (
                                                            <div>
                                                                ...
                                                                <p className="text-xs text-gray-500">{ride.driverId?.substring(0, 8)}...</p>
                                                            </div>
                                                        ) : (
                                                                    ...
                                                                    <div className="grid grid-cols-2 gap-4 bg-white p-4 rounded-lg">
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <p className="text-gray-900">
                                                                                {ride.pricing?.finalFare || ride.pricing?.estimatedFare || ride.fare || 'N/A'} 
                                                                                {ride.pricing?.currency && ` ${ride.pricing.currency}`}
                                                                            </p>
                                                                        </div>
                                                                        <div>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div className="grid grid-cols-2 gap-4 bg-white p-4 rounded-lg">
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <p className="text-gray-900 font-mono text-xs">{ride.driverId}</p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                )}
