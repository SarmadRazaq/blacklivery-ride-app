...
class ResponsiveLayout extends StatelessWidget {
  const ResponsiveLayout({
    ...
    this.unselectedNavColor = const Color(0xFF9E9E9E),
...
// ─────────────────────────────────────────────────────────────────────────────
// Mobile / Tablet — NavigationBar (Material 3 bottom nav)
// ─────────────────────────────────────────────────────────────────────────────
...
/// prevent overflow.
///
/// ### Sample — adaptive earnings-card grid
/// ```dart
/// ResponsiveTileGrid(
///   itemCount: earningsItems.length,
///   desktopColumns: 3,
///   childAspectRatio: 2.2,
///   padding: const EdgeInsets.all(16),
///   itemBuilder: (context, i) => _EarningsCard(item: earningsItems[i]),
/// )
/// ```
